...
```{ojs}
apiRoot = "https://titanic-du-feu-de-dieu.lab.sspcloud.fr"
```
...
Retrouver l'API sur [https://titanic-du-feu-de-dieu.lab.sspcloud.fr/docs](https://titanic-du-feu-de-dieu.lab.sspcloud.fr/docs) pour jouer avec
d'autres exemples.
